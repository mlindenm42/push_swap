...
/*   Updated: 2023/05/15 19:26:58 by mlindenm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rra(t_stack_ptr *stack_ptr)
{
	...
	ptr = NULL;
	ptr = remove_node_from_stack_bottom(stack_ptr, stack_ptr->a);
...
void	rrb(t_stack_ptr *stack_ptr)
{
	...
	ptr = NULL;
	ptr = remove_node_from_stack_bottom(stack_ptr, stack_ptr->b);
